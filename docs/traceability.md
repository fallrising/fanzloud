...
| T010 strong IDs, paths, and base errors | CU-FS-00 | SPEC-T010; TD §16.1 | T010 acceptance suite | `crates/codebox-domain/**` | Local checks passed; hosted [CI run 30262687153](https://github.com/fallrising/fanzloud/actions/runs/30262687153) passed on `aa56b75`; fresh acceptance review unavailable | Verifying |
